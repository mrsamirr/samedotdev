...
export default function ProfileSidebar({ sidebarToggle }: ProfileSidebarProps) {
  ...
  return (
    <div
      className={`${
        sidebarToggle
          ? "block transition-all dark:bg-[#06080d] py-3 lg:dark:bg-[#1d26435c] z-20 duration-100 fixed top-0 left-0 w-[60%] lg:w-[50%]"
          : "hidden lg:block"
      } col-span-2 top-10 h-full`}
    >
